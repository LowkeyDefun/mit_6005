...
public class TurtleSoup {
    ...
    public static double calculateRegularPolygonAngle(int sides) {
        return 180 * (sides - 2) / Integer.valueOf(sides).doubleValue();
    }
    ...
    public static int calculatePolygonSidesFromAngle(double angle) {
        return Long.valueOf(Math.round(360 / (180.0 - angle))).intValue();
    }
    ...
    public static double calculateHeadingToPoint(double currentHeading, int currentX, int currentY,
        ...
        // Check for special cases where Y coordinates are the same.
    	if (targetY == currentY) {
        	if (targetX > currentX) {
        		angle = 90;
        	} else {
    	...
    	// Map the final result into the required range.
